...
There's also the privacy angle that's easy to overlook. Screenhots often contain names, project identifiers, API keys visible in browser chrome, or internal UI. You might not want that sitting on an unknown server, even briefly.
