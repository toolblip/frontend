...
const TOOL_SLUG_ALIASES: Record<string, string> = {
  ...
  'json-toml-converter': 'toml-to-json',
  'toml-json-converter': 'toml-to-json',
...
export const tools: Tool[] = [
  ...
  { name: 'TOML-JSON Converter', slug: 'toml-to-json', description: 'Convert between TOML and JSON with live side-by-side panes. Paste either format and the other updates instantly in your browser.', emoji: '🔄', category: 'Conversion' },
