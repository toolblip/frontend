...
export const tools: Tool[] = [
  ...
  { name: 'Image Rotate Tool', slug: 'image-rotate', description: 'Rotate PNG, JPEG, WebP, GIF, or SVG images clockwise by 90, 180, or 270 degrees and download a PNG.', emoji: '🔄', category: 'Image' },
  { name: 'Image Flip Tool', slug: 'image-flip', description: 'Mirror PNG, JPEG, WebP, GIF, or SVG images horizontally, vertically, or both ways and download a PNG.', emoji: '🔃', category: 'Image' },
  ...
  { name: 'Add Border to Image', slug: 'border', description: 'Add a 1 to 100 px opaque outside border to an image and download a PNG with the original interior preserved.', emoji: '🖼️', category: 'Image' },
  ...
  { name: 'Image Collage Maker', slug: 'collage-maker', description: 'Build PNG collages in 2x1 through 3x3 layouts with square cells, adjustable gaps, and a solid background color.', emoji: '🖼️', category: 'Image' },
  { name: 'Combine Images', slug: 'combine-images', description: 'Combine 2 to 12 images horizontally, vertically, or in a grid with adjustable spacing and a white PNG background.', emoji: '🖼️', category: 'Image' },
