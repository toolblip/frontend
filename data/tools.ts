...
export const tools: Tool[] = [
  ...
  { name: 'Favicon Generator', slug: 'favicon-generator', description: 'Create a favicon from a typed emoji or up to two characters. Choose one size from 16 to 512px, then download PNG, ICO, or SVG.', emoji: '🌐', category: 'Image' },
