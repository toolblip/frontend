...
export const tools: Tool[] = [
  ...
  { name: 'PDF Password Remover', slug: 'pdf-password-remover', description: 'Unlock PDFs you have permission to access with browser-local password handling. Files never leave your device.', emoji: '🔓', category: 'Utility' },
  ...
  { name: 'Add Pages to PDF', slug: 'add-pages-to-pdf', description: 'Add blank or existing pages to a PDF document at a chosen position.', emoji: '📄', category: 'PDF Tools' },
  ...
  { name: 'Workflow Outline Builder', slug: 'automation-wizard', description: 'Draft workflow steps and copy a generic JSON or YAML outline. Does not run workflows or connect apps.', emoji: '⚡', category: 'Utility' },
  ...
  { name: 'Edit PDF', slug: 'edit-pdf', description: 'Add text and image overlays to PDF files without changing the original content.', emoji: '📄', category: 'PDF Tools' },
  ...
  { name: 'Extract Images from PDF', slug: 'extract-images-from-pdf', description: 'Extract common embedded raster images from a PDF file. Download them as a ZIP or individually.', emoji: '📄', category: 'PDF Tools' },
