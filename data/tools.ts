...
const TOOL_SLUG_ALIASES: Record<string, string> = {
  ...
  'hex-to-rgb-express': 'hex-to-rgb',
  'hex-to-rgb-new': 'hex-to-rgb',
  'hsl-to-rgb-express': 'hsl-to-rgb',
  'hsl-to-rgb-new': 'hsl-to-rgb',
...
export const tools: Tool[] = [
  ...
  { name: 'HEX to RGB Converter', slug: 'hex-to-rgb', description: 'Convert HEX color codes to RGB and RGBA formats with live color preview.', emoji: '🎨', category: 'Color' },
