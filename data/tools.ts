...
export const tools: Tool[] = [
  ...
  { name: 'Add Pages to PDF', slug: 'add-pages', description: 'Add blank or existing pages to a PDF document at a chosen position.', emoji: '📄', category: 'PDF Tools' },
  ...
  { name: 'Edit PDF', slug: 'edit', description: 'Add text and image overlays to PDF files without changing the original content.', emoji: '📄', category: 'PDF Tools' },
  ...
  { name: 'Extract Images from PDF', slug: 'extract-img', description: 'Extract common embedded raster images from a PDF file. Download them as a ZIP or individually.', emoji: '📄', category: 'PDF Tools' },
