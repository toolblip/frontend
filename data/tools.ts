...
export const tools: Tool[] = [
  ...
  { name: 'Remove Image Background', slug: 'remove-bg', description: 'Cut out the background from any image. Clean subject isolation.', emoji: '🖼️', category: 'Image', tags: ['background', 'transparent', 'photo-editing', 'png'] },
