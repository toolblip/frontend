...
const TOOL_SLUG_ALIASES: Record<string, string> = {
  ...
  'json-to-tsv': 'csv-to-json',
  'json-to-xml': 'xml-to-json',
  'json-to-yaml': 'yaml-to-json',
  'tsv-json': 'csv-to-json',
  'tsv-json-express': 'csv-to-json',
  ...
  'json-csv-express': 'csv-to-json',
  'json-path-tester-new': 'json-path-tester',
  'json-schema-gen-express': 'json-ld-generator',
  'json-to-csv-v2': 'csv-to-json',
  'json-to-xml-v2': 'xml-to-json',
  'json-to-yaml-v2': 'yaml-to-json',
  'json-xml-express': 'xml-to-json',
  'json-yaml-express': 'yaml-to-json',
  ...
  'tsv-to-json': 'csv-to-json',
  'tsv-to-json-v2': 'csv-to-json',
...
export const tools: Tool[] = [
  ...
  { name: 'YAML ↔ JSON', slug: 'yaml-to-json', description: 'Convert between YAML and JSON with live preview, pretty-print, and one-click swap. Runs in your browser.', emoji: '🔄', category: 'Conversion' },
  ...
  { name: 'XML ↔ JSON', slug: 'xml-to-json', description: 'Convert between XML and JSON with attribute handling, root element control, and live preview. Runs in your browser.', emoji: '📋', category: 'Conversion' },
  ...
  { name: 'CSV / TSV ↔ JSON', slug: 'csv-to-json', description: 'Convert between CSV, TSV, and JSON with header detection, type inference, and live preview. Runs in your browser.', emoji: '📋', category: 'Conversion' },
  ...
  { name: 'TSV ↔ CSV', slug: 'tsv-to-csv', description: 'Convert between TSV and CSV with proper quoting and live preview. Runs in your browser.', emoji: '📄', category: 'Conversion' },
