...
export const tools: Tool[] = [
  ...
  { name: 'Image Compressor', slug: 'image-compressor', description: 'Compress JPEG, PNG, and WebP images with real quality controls, side-by-side preview, and original fallback when output would grow.', emoji: '🗜️', category: 'Image' },
