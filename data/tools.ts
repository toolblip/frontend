...
export const tools: Tool[] = [
  ...
  { name: 'Delete PDF Pages', slug: 'delete-pages', description: 'Select and remove unwanted pages from a PDF while keeping at least one page.', emoji: '📄', category: 'PDF Tools' },
  ...
  { name: 'Sign PDF', slug: 'sign', description: 'Add a visual signature to a PDF by drawing, typing, or uploading a signature image.', emoji: '✍️', category: 'PDF Tools' },
  ...
  { name: 'Unlock PDF', slug: 'unlock', description: 'Remove an opening password from PDFs you have permission to access using browser-local processing.', emoji: '🔓', category: 'PDF Tools' },
  { name: 'Add Watermark to PDF', slug: 'watermark', description: 'Add a visible text or image watermark to every page of a PDF.', emoji: '📄', category: 'PDF Tools' },
