...
const TOOL_SLUG_ALIASES: Record<string, string> = {
  ...
  'csv-to-json-v2': 'json-to-csv',
  'csv-json-express': 'json-to-csv',
  'json-to-tsv': 'json-to-csv',
  'tsv-json': 'json-to-csv',
  'tsv-json-express': 'json-to-csv',
  'tsv-to-json': 'json-to-csv',
  'tsv-to-json-v2': 'json-to-csv',
  ...
  'tsv-to-csv': 'csv-to-tsv',
  'tsv-to-csv-v2': 'csv-to-tsv',
  ...
  'toml-to-json-v2': 'json-to-toml',
  'json-toml-converter': 'json-to-toml',
  'toml-json-converter': 'json-to-toml',
  'toml-to-json-converter': 'json-to-toml',
...
export const tools: Tool[] = [
  ...
  { name: 'JSON-YAML Converter', slug: 'json-to-yaml', description: 'Convert between JSON and YAML with live side-by-side panes. Paste either format and the other updates instantly in your browser.', emoji: '🔄', category: 'Conversion' },
  ...
  { name: 'JSON-XML Converter', slug: 'json-to-xml', description: 'Convert between JSON and XML with live side-by-side panes, attribute handling, and root element control. Paste either format and the other updates instantly in your browser.', emoji: '📋', category: 'Conversion' },
  ...
  { name: 'JSON-CSV Converter', slug: 'json-to-csv', description: 'Convert between JSON and CSV with live side-by-side panes, header detection, and type inference. Paste either format and the other updates instantly in your browser.', emoji: '📋', category: 'Conversion' },
  ...
  { name: 'CSV-TSV Converter', slug: 'csv-to-tsv', description: 'Convert between CSV and TSV with live side-by-side panes and proper quoting. Paste either format and the other updates instantly in your browser.', emoji: '📄', category: 'Conversion' },
  ...
  { name: 'JSON-TOML Converter', slug: 'json-to-toml', description: 'Convert between JSON and TOML with live side-by-side panes. Paste either format and the other updates instantly in your browser.', emoji: '🔄', category: 'Conversion' },
