...
export const tools: Tool[] = [
  ...
  { name: 'Image Resizer', slug: 'image-resizer', description: 'Free online image resizer. Resize one image to exact pixel dimensions with an aspect ratio lock and PNG download. Files stay in your browser.', emoji: '📐', category: 'Image' },
