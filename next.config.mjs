...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/tools/tsv-json-express', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/yaml-to-json', destination: '/tools/json-to-yaml', permanent: true },
      { source: '/tools/yaml-to-json-v2', destination: '/tools/json-to-yaml', permanent: true },
      { source: '/tools/yaml-json-express', destination: '/tools/json-to-yaml', permanent: true },
      { source: '/tools/json-to-yaml-v2', destination: '/tools/json-to-yaml', permanent: true },
      { source: '/tools/json-yaml-express', destination: '/tools/json-to-yaml', permanent: true },
      { source: '/tools/xml-to-json', destination: '/tools/json-to-xml', permanent: true },
      { source: '/tools/xml-to-json-v2', destination: '/tools/json-to-xml', permanent: true },
      { source: '/tools/xml-json-express', destination: '/tools/json-to-xml', permanent: true },
      { source: '/tools/json-to-xml-v2', destination: '/tools/json-to-xml', permanent: true },
      { source: '/tools/json-xml-express', destination: '/tools/json-to-xml', permanent: true },
      { source: '/tools/csv-to-json', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/csv-to-json-v2', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/csv-json-express', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/json-to-csv-v2', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/json-csv-express', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/tsv-json', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/tsv-to-json', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/tsv-to-json-v2', destination: '/tools/json-to-csv', permanent: true },
      { source: '/tools/tsv-to-csv', destination: '/tools/csv-to-tsv', permanent: true },
      { source: '/tools/tsv-to-csv-v2', destination: '/tools/csv-to-tsv', permanent: true },
      { source: '/tools/csv-to-tsv-v2', destination: '/tools/csv-to-tsv', permanent: true },
      { source: '/tools/toml-to-json', destination: '/tools/json-to-toml', permanent: true },
      { source: '/tools/toml-to-json-v2', destination: '/tools/json-to-toml', permanent: true },
      { source: '/tools/json-toml-converter', destination: '/tools/json-to-toml', permanent: true },
      { source: '/tools/toml-json-converter', destination: '/tools/json-to-toml', permanent: true },
      { source: '/tools/toml-to-json-converter', destination: '/tools/json-to-toml', permanent: true },
      { source: '/tools/json-to-toml-converter', destination: '/tools/json-to-toml', permanent: true },
