...
const slugs = ['english-dictionary', 'shell-command-reference', 'notebook-to-html', 'base64-encoder-decoder', 'binary-converter', 'binary-to-text', 'markdown-to-pdf', 'json-schema-validator'];
...
const sourceFiles = ['scripts/qa/hosted-candidate.mjs', 'scripts/qa/run.mjs', 'scripts/qa/browser.mjs', 'scripts/qa/runtime.mjs', 'scripts/qa/cases/developer-data.mjs', 'scripts/qa/cases/developer-general.mjs', 'scripts/qa/cases/developer-security.mjs', 'scripts/qa/cases/utility-design.mjs', 'lib/blog.ts', 'lib/utility-design/dictionary.ts', 'lib/developer-data/use-schema-validation.ts', 'components/tools/EnglishDictionaryClient.tsx', 'components/tools/ShellCommandReferenceClient.tsx'];
