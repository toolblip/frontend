...
export default function ShareButtons({ toolName, toolSlug }: ShareButtonsProps) {
  ...
  const btnClass = "inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg transition-colors";
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <a
        ...
        className={btnClass}
        aria-label={`Share ${toolName} on Twitter/X`}
      >
