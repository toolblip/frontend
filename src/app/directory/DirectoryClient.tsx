      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-4 pt-10 pb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-xl">
            Browse all {tools.length} free browser-based tools. No sign-up, no uploads — everything runs instantly in your browser.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-5">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            {activeCategory !== 'All' && (
              <span className="ml-1">
                in <span className="text-green-600 dark:text-green-400 font-medium">{activeCategory}</span>
              </span>
            )}
            {search && (
              <span className="ml-1">
                for &ldquo;<span className="text-gray-700 dark:text-gray-200">{search}</span>&rdquo;
              </span>
            )}
          </p>
          <Link
        ...
        {filtered.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-sm leading-relaxed">
              ...
              {activeCategory !== 'All' ? ` in the ${activeCategory} category` : ''}. Try a different search or browse all categories.
            </p>
            <button
