...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary', title: 'API Documentation | Toolblip', description: 'Toolblip REST API — free endpoints for browsing developer tools and user authentication.' },
};
