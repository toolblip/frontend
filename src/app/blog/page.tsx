...
function getPosts(): Post[] {
  ...
  return fs
    ...
    .map((file) => {
      ...
      const date = (data.date as string) || (data.publishDate as string) || '';
      return {
...
const CATEGORY_GRADIENTS: Record<string, [string, string]> = {
  'Developer Tools': ['#0ea5e9', '#8b5cf6'],
  Authentication: ['#f59e0b', '#ef4444'],
  Design: ['#10b981', '#06b6d4'],
  SEO: ['#f97316', '#facc15'],
  'Social Media': ['#ec4899', '#8b5cf6'],
  Cryptography: ['#6366f1', '#ec4899'],
  Performance: ['#14b8a6', '#0ea5e9'],
  Reference: ['#64748b', '#475569'],
  MCP: ['#a78bfa', '#6366f1'],
  Guide: ['#10b981', '#06b6d4'],
  Tutorial: ['#0ea5e9', '#06b6d4'],
  Misc: ['#6b7280', '#374151'],
};
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
                    <span className="bg-green-500/10 text-green-400 px-2 py-0.5 rounded font-medium">
                      {post.category}
                    </span>
                  ...
                  >
                    <h2 className="text-lg font-semibold text-white group-hover:text-green-400 transition-colors mb-2 leading-snug">
                      {post.title}
                    </h2>
