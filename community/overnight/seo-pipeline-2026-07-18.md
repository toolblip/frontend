# Toolblip SEO Pipeline Archive — 2026-07-18

**Pipeline Status:** Run completed — content generation blocked by Claude auth (day 7)
...
| UTC Window | 17:06 UTC (23:06 Dhaka) — within overnight window ✅ |
| Pipeline exit code | 0 |
| Claude Code auth | ❌ Not logged in (persistent — day 7: July 12–18) |
| GitHub auth | ✅ Logged in as `HarunRRayhan` |
| GSC API | ✅ Working (sitemap refresh succeeded) |

## What happened

1. **Pipeline invoked** via `bash scripts/seo-pipeline.sh 1` at 23:06 Dhaka
2. **Branch check** passed (`main`)
3. **Window check** passed (17:06 UTC, inside 17:00–23:59 UTC window)
...
**Claude Code auth (persistent — day 7)**
...
- Claude auth broken: 2026-07-12 through 2026-07-18 (7 consecutive nights)
