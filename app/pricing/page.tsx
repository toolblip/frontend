...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Start a 14-day free trial with no card required on Toolblip. Free, Starter ($4.99/mo), Pro ($19.99/mo), and Max ($49.99/mo) plans with no ads, cloud storage, and team features.',
  openGraph: {
    title: 'Pricing | Toolblip',
    description: 'Start a 14-day free trial with no card required. Plans start at $4.99/month.',
...
const faqSchema: Record<string, unknown> = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Toolblip includes a 14-day free trial with no card required. You can also stay on the free plan and upgrade later when you're ready.",
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No card is required to start the free trial. If you upgrade later, we accept all major credit and debit cards via Stripe.',
      },
    },
    {
      '@type': 'Question',
