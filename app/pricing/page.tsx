...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Upgrade to Toolblip for an ad-free experience. Free, Starter ($4.99/mo), Ultra ($19.99/mo), and Business ($49.99/mo) plans with no ads, cloud storage, and team features.',
  openGraph: {
...
const faqSchema: Record<string, unknown> = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ultra plans include 3 team seats and Business plans include 10 team seats, allowing multiple users to collaborate under one account.',
      },
    },
  ],
};
