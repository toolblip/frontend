    ...
    <div className="tb-v2-donate">
      <div className="tb-v2-container">
        <div className="tb-v2-article">
          ...
          <div className="tb-v2-donate-btns">
            <a
              href="https://github.com/sponsors/HarunRRayhan"
              target="_blank"
              rel="noopener noreferrer"
              className="tb-v2-donate-btn"
              style={{ background: 'var(--fg-0)' }}
            >
              <svg xmlns="https://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div className="tb-v2-donate-section">
