          ...
          {faqs.length > 0 && (
            <div>
              ...
              <dl className="space-y-4">
                {faqs.map((f, i) => (
                  <div key={i}>
                    <dt className="text-sm font-medium text-gray-800 dark:text-gray-100">{f.q}</dt>
                    <dd className="mt-1 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{f.a}</dd>
                  </div>
                ))}
              </dl>
            </div>
