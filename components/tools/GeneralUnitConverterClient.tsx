...
export default function GeneralUnitConverterClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">General Unit Converter</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert between length, weight, temperature, speed, area, and volume units instantly.</p>
      <textarea
        value={input}
