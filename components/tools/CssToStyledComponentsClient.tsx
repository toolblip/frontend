...
export default function CssToStyledComponentsClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Css To Styled Components</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert plain CSS to styled-components template literal syntax for React.</p>
      <textarea
        value={input}
