...
export default function EpsToJpgClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Eps To Jpg</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert EPS vector files to JPG images. High quality rasterization.</p>
      <textarea
        value={input}
