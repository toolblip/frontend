...
export default function GrammarCheckerNewClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Grammar Checker New</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for grammar checker new</p>
      <textarea
        value={input}
