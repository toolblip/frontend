...
export default function CronToolblipClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Cron Toolblip</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for cron toolblip</p>
      <textarea
        value={input}
