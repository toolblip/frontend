  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="tb-v2-tool-input-head">
        <span className="tb-v2-tool-label">Contrast Browser</span>
      ...
      <div className="tb-v2-section" style={{display:"flex",flexDirection:"column",gap:16,padding:"16px 20px"}}>
        <div>
          <label className="tb-v2-tool-label" style={{marginBottom:8}}>Foreground Color</label>
        ...
        <div>
          <label className="tb-v2-tool-label" style={{marginBottom:8}}>Background Color</label>
          <div className="flex gap-2 items-center">
