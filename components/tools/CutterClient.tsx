...
export default function CutterClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Cutter</h1>
      <p className="text-gray-600 dark:text-gray-400">Cut and trim video files. Remove unwanted sections without re-encoding.</p>
      <textarea
        value={input}
