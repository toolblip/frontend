...
export default function FaviconGeneratorAdvancedClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Favicon Generator Advanced</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for favicon generator advanced</p>
      <textarea
        value={input}
