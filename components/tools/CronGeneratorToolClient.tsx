...
export default function CronGeneratorToolClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Cron Generator Tool</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for cron generator tool</p>
      <textarea
        value={input}
