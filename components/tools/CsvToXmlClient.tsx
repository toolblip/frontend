...
export default function CsvToXmlClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Csv To Xml</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert CSV to XML format. Map columns to XML elements automatically.</p>
      <textarea
        value={input}
