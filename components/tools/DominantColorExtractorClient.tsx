...
export default function DominantColorExtractorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Dominant Color Extractor</h1>
      <p className="text-gray-600 dark:text-gray-400">Extract top dominant colors from any image and get HEX and RGB values instantly.</p>
      <textarea
        value={input}
