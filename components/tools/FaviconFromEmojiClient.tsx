...
export default function FaviconFromEmojiClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Favicon From Emoji</h1>
      <p className="text-gray-600 dark:text-gray-400">Turn any emoji into a favicon PNG instantly. Download in multiple sizes.</p>
      <textarea
        value={input}
