...
export default function FaviconGrabberClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Favicon Grabber</h1>
      <p className="text-gray-600 dark:text-gray-400">Download the favicon from any website URL in ICO, PNG, and SVG formats.</p>
      <textarea
        value={input}
