...
export default function DuplicatePhraseDetectorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Duplicate Phrase Detector</h1>
      <p className="text-gray-600 dark:text-gray-400">Find repeated phrases and word patterns in any text block for cleaner writing.</p>
      <textarea
        value={input}
