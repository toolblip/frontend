...
export default function ContrastCheckerCompleteClient() {
  ...
  return (
    <div className="tb-v2-card">
      <div className="tb-v2-card-header">
        <h2 className="tb-v2-card-title">Contrast Checker Complete</h2>
        <p className="tb-v2-card-desc">Complete WCAG contrast checking solution</p>
      </div>
