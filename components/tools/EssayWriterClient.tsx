...
export default function EssayWriterClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Essay Writer</h1>
      <p className="text-gray-600 dark:text-gray-400">Write complete essays with AI assistance. From topic to conclusion.</p>
      <textarea
        value={input}
