...
export default function ContrastCheckerDgClient() {
  ...
  return (
    <div className="tb-v2-card">
      <div className="tb-v2-card-header">
        <h2 className="tb-v2-card-title">Contrast Checker DG</h2>
        <p className="tb-v2-card-desc">Digital gradient contrast checker</p>
      </div>
