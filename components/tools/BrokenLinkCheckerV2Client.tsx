  ...
  return (
    <div className="tb-v2-stack">
      ...
      {results.length > 0 && (
        <>
          <div className="tb-v2-card">
            <div className="tb-v2-flex-row" style={{ gap: '1rem' }}>
              <span className="tb-v2-badge bg-green-100 text-green-700">{ok} OK</span>
              <span className="tb-v2-badge bg-red-100 text-red-700">{broken} Broken</span>
            </div>
          </div>
          <div className="tb-v2-card">
            <h3 className="tb-v2-label">All Links</h3>
            <div className="tb-v2-stack">
              {results.map((r, i) => (
