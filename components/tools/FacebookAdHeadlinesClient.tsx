...
export default function FacebookAdHeadlinesClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Facebook Ad Headlines</h1>
      <p className="text-gray-600 dark:text-gray-400">Generate catchy Facebook ad headlines. Increase click-through rates.</p>
      <textarea
        value={input}
