...
export default function FaviconGenerator2025Client() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Favicon Generator2025</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for favicon generator2025</p>
      <textarea
        value={input}
