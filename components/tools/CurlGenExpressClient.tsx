...
export default function CurlGenExpressClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Curl Gen Express</h1>
      <p className="text-gray-600 dark:text-gray-400">Generate cURL commands from browser network requests with headers and body options.</p>
      <textarea
        value={input}
