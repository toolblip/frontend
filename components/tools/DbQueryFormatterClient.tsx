...
export default function DbQueryFormatterClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Db Query Formatter</h1>
      <p className="text-gray-600 dark:text-gray-400">Format and prettify SQL queries with keyword highlighting and indentation.</p>
      <textarea
        value={input}
