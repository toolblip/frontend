...
export default function HeicToJpgClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Heic To Jpg</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert HEIC iPhone photos to JPG format. Universal compatibility.</p>
      <textarea
        value={input}
