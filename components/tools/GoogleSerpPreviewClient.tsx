...
export default function GoogleSerpPreviewClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Google Serp Preview</h1>
      <p className="text-gray-600 dark:text-gray-400">Preview how your page title and description appear in actual Google search results.</p>
      <textarea
        value={input}
