...
export default function FrequencyConverterClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Frequency Converter</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert between hertz, kilohertz, megahertz, gigahertz, and RPM instantly.</p>
      <textarea
        value={input}
