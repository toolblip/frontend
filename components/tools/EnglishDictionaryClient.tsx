...
export default function EnglishDictionaryClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">English Dictionary</h1>
      <p className="text-gray-600 dark:text-gray-400">Look up word definitions, synonyms, antonyms, and pronunciation guides.</p>
      <textarea
        value={input}
