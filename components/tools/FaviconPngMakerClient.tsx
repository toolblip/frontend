...
export default function FaviconPngMakerClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Favicon Png Maker</h1>
      <p className="text-gray-600 dark:text-gray-400">Generate PNG favicon icons in standard sizes from any image or emoji with transparent background.</p>
      <textarea
        value={input}
