...
export default function ForceConverterClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Force Converter</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert between newtons, dynes, pounds-force, and kilogram-force units.</p>
      <textarea
        value={input}
