...
export default function CurlCommandBuilderClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Curl Command Builder</h1>
      <p className="text-gray-600 dark:text-gray-400">Build cURL commands with custom method, headers, body, and authentication.</p>
      <textarea
        value={input}
