...
export default function CronExprGenUltraClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Cron Expr Gen Ultra</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for cron expr gen ultra</p>
      <textarea
        value={input}
