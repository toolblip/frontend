  ...
  return (
    <div>
      <div className="tb-v2-tool-input-head">
        <span className="tb-v2-tool-label">Cron Expression Parser</span>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        ...
        />
        <button type="button" onClick={() => generate()} className="tb-v2-btn tb-v2-btn-primary">Parse</button>
      </div>
      ...
      {result.valid ? (
        <>
          ...
          <div className="tb-v2-cron-fields">
            {result.parts && (
              <>
                <div className="tb-v2-cron-field">
                  <span className="tb-v2-cron-field-label">Minute</span>
                  <code className="tb-v2-cron-field-range">{result.parts[0]}</code>
                </div>
                <div className="tb-v2-cron-field">
                  <span className="tb-v2-cron-field-label">Hour</span>
                  <code className="tb-v2-cron-field-range">{result.parts[1]}</code>
                </div>
                <div className="tb-v2-cron-field">
                  <span className="tb-v2-cron-field-label">Day</span>
                  <code className="tb-v2-cron-field-range">{result.parts[2]}</code>
                </div>
                <div className="tb-v2-cron-field">
                  <span className="tb-v2-cron-field-label">Month</span>
                  <code className="tb-v2-cron-field-range">{result.parts[3]}</code>
                </div>
                <div className="tb-v2-cron-field">
                  <span className="tb-v2-cron-field-label">Weekday</span>
                  <code className="tb-v2-cron-field-range">{result.parts[4]}</code>
                </div>
              </>
            )}
          </div>
