  ...
  return (
    <div className="tb-v2-card">
      <div className="tb-v2-card-header">
        <h2 className="tb-v2-card-title">Contrast Checker API</h2>
        <p className="tb-v2-card-desc">API-powered contrast checking for developers</p>
      </div>
      <div className="tb-v2-card-body">
        ...
        <div style={{ backgroundColor: bg, color: fg, padding: '1rem', borderRadius: '8px', marginBottom: '1rem', fontFamily: 'monospace' }}>
