...
export default function GifToAvifClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Gif To Avif</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert GIF to AVIF format. Modern codec with excellent compression.</p>
      <textarea
        value={input}
