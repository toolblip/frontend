...
export default function ExcelToPdfClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Excel To Pdf</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert Excel spreadsheets to PDF format. Preserve formatting and layout.</p>
      <textarea
        value={input}
