...
export default function HttpHeadersInspectorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Http Headers Inspector</h1>
      <p className="text-gray-600 dark:text-gray-400">View and debug HTTP request and response headers for any URL with timing breakdown.</p>
      <textarea
        value={input}
