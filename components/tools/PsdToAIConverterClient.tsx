...
export default function PsdToAIConverterClient({ tool = { name: "", slug: "", description: "" } }: Props) {
  ...
  const handleProcess = async () => {
    ...
    setIsLoading(true);
    // PSD to AI conversion logic here
    setOutput(input);
    setIsLoading(false);
  };
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <textarea
        ...
        placeholder="{Upload a PSD file to convert...}"
      />
