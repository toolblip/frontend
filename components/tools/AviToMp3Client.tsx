...
export default function AviToMp3Client() {
  ...
  const handleExtract = async () => {
    ...
    try {
      // Browsers cannot encode MP3, and most cannot decode AVI's video/audio
      // codecs at all. We attempt a real decode via Web Audio and bail out
      // with a clear error rather than shipping a fake "audio.wav" file.
      ...
      setError('This AVI file\'s audio codec could not be decoded in-browser. Use FFmpeg (ffmpeg -i video.avi -vn -acodec pcm_s16le output.wav) instead.');
    } finally {
    ...
    <div className="tb-v2-section" style={{display:"flex",flexDirection:"column",gap:16,padding:"16px 20px"}}>
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400">
          {isDragging ? 'Drop AVI file here' : 'Click or drag an AVI file to extract audio'}
        </p>
      ...
      {!file && (
        <p className="tb-v2-empty">
          Upload an AVI file above to extract its audio track as a WAV file.
        </p>
      )}
