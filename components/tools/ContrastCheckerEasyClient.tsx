...
export default function ContrastCheckerEasyClient() {
  ...
  return (
    <div className="tb-v2-card">
      <div className="tb-v2-card-header">
        <h2 className="tb-v2-card-title">Contrast Checker Easy</h2>
        <p className="tb-v2-card-desc">Easy contrast checking for everyone</p>
      </div>
