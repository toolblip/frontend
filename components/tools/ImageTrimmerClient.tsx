      ...
      {!image ? (
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-gray-500">
            ...
            It only works on images with a flat, uniform-color margin (screenshots, logos, scans) - it can&apos;t
            crop a photo&apos;s subject out of a busy background. For that, try{' '}
            <Link href="/tools/image-background-remover" className="text-red-500 hover:underline">
              Background Remover
            </Link>{' '}
            instead.
          </p>
          ...
          {status === 'nothing-to-trim' && (
            <p className="text-xs text-amber-500">
              No uniform border found at this tolerance, try raising it. If the image has no solid-color
              margin at all (e.g. a photo with a busy background), no tolerance will help - try{' '}
              <Link href="/tools/image-background-remover" className="underline">
                Background Remover
              </Link>{' '}
              instead.
            </p>
