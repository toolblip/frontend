...
export default function FaqGeneratorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Faq Generator</h1>
      <p className="text-gray-600 dark:text-gray-400">Generate FAQ sections for any topic. SEO-friendly question-answer pairs.</p>
      <textarea
        value={input}
