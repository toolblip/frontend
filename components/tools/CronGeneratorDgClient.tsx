...
export default function CronGeneratorDgClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Cron Generator Dg</h1>
      <p className="text-gray-600 dark:text-gray-400">Build cron schedules visually with point-and-click editor and human-readable output.</p>
      <textarea
        value={input}
