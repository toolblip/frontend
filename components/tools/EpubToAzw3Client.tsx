...
export default function EpubToAzw3Client() {
      ...
      {meta && (
        <div style={{ padding: '0 20px 20px' }}>
          <div className="tb-v2-banner" style={{ marginBottom: 16 }}>
            Generating a real, device-valid Kindle AZW3 (KF8) file requires Amazon's proprietary binary packaging
            and can't be reliably produced in-browser. Below is the book's real metadata and content, extracted
            directly from the EPUB, with an HTML export you can open anywhere or convert offline with Calibre or
            Kindle Previewer.
          </div>
