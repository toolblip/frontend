...
export default function GifToJpgClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Gif To Jpg</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert animated GIF to static JPG image. Extract first frame or create thumbnail.</p>
      <textarea
        value={input}
