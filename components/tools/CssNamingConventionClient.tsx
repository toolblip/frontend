...
export default function CssNamingConventionClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Css Naming Convention</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert CSS class names between BEM, kebab-case, camelCase, and SCSS conventions.</p>
      <textarea
        value={input}
