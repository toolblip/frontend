...
export default function GrammarScoreCheckerClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Grammar Score Checker</h1>
      <p className="text-gray-600 dark:text-gray-400">Get a grammar quality score for your text with specific suggestions for improvement.</p>
      <textarea
        value={input}
