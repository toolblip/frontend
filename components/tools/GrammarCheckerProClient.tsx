...
export default function GrammarCheckerProClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Grammar Checker Pro</h1>
      <p className="text-gray-600 dark:text-gray-400">Advanced grammar and spell checker with style suggestions, tone detection, and one-click fixes.</p>
      <textarea
        value={input}
