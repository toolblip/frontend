...
export default function HeicToPngClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Heic To Png</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert HEIC images to PNG. Preserve quality and transparency.</p>
      <textarea
        value={input}
