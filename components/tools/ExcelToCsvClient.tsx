...
export default function ExcelToCsvClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Excel To Csv</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert Excel spreadsheets to CSV format. Fast and accurate data export.</p>
      <textarea
        value={input}
