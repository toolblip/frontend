...
export default function DnsLookupV2Client() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Dns Lookup V2</h1>
      <p className="text-gray-600 dark:text-gray-400">Query DNS records for any domain - A, AAAA, MX, TXT, and CNAME records.</p>
      <textarea
        value={input}
