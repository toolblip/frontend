...
export default function ContrastCheckerBrowserClient() {
  ...
  return (
    <div className="tb-v2-card">
      <div className="tb-v2-card-header">
        <h2 className="tb-v2-card-title">Contrast Checker Browser</h2>
        <p className="tb-v2-card-desc">Check contrast directly in your browser</p>
      </div>
