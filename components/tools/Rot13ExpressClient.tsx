...
export default function Rot13ExpressClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Rot13 Express</h1>
      <p className="text-gray-600 dark:text-gray-400">Apply ROT13 substitution cipher to encode or decode text instantly in your browser.</p>
      <textarea
        value={input}
