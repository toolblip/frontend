...
export default function EnvParserClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Env Parser</h1>
      <p className="text-gray-600 dark:text-gray-400">Parse and validate .env files, extract keys and values, and detect syntax errors.</p>
      <textarea
        value={input}
