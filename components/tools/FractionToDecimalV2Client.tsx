...
export default function FractionToDecimalV2Client() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Fraction To Decimal V2</h1>
      <p className="text-gray-600 dark:text-gray-400">Tool for fraction to decimal v2</p>
      <textarea
        value={input}
