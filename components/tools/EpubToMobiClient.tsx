...
export default function EpubToMobiClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Epub To Mobi</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert EPUB to MOBI format for Kindle devices. Free and instant.</p>
      <textarea
        value={input}
