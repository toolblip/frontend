...
export default function ExcelToXmlClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Excel To Xml</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert Excel data to XML format. Map cells to XML elements easily.</p>
      <textarea
        value={input}
