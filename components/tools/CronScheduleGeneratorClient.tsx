...
export default function CronScheduleGeneratorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Cron Schedule Generator</h1>
      <p className="text-gray-600 dark:text-gray-400">Build cron schedules visually with a point-and-click editor and human-readable preview.</p>
      <textarea
        value={input}
