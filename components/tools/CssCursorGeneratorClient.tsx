...
export default function CssCursorGeneratorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Css Cursor Generator</h1>
      <p className="text-gray-600 dark:text-gray-400">Generate custom CSS cursor values with URL images, fallback cursors, and CSS output.</p>
      <textarea
        value={input}
