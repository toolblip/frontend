...
export default function CssFlexboxGeneratorClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <p className="text-gray-600 dark:text-gray-400">Free online CSS Flexbox generator. Build flex layouts visually with direction, wrap, justify-content, and align-items controls. Copy CSS instantly.</p>
      <textarea
        value={input}
