...
export default function MakeBackgroundTransparent({ tool = { name: "", description: "" } }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4">{tool?.name ?? "MakeBackgroundTransparent"}</h1>
