...
export default function GifToPngClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Gif To Png</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert GIF to PNG format. Preserve transparency in static output.</p>
      <textarea
        value={input}
