...
export default function ContrastCheckerClassicClient() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="tb-v2-tool-input-head">
        <span className="tb-v2-tool-label">Contrast Checker Classic</span>
      ...
      <div className="tb-v2-section" style={{display:"flex",flexDirection:"column",gap:16,padding:"16px 20px"}}>
        ...
        <div style={{ backgroundColor: bg, color: fg, padding: '1rem', borderRadius: '8px', textAlign: 'center' }}>
          Classic Preview
        </div>
