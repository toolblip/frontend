    ...
    <div className="tb-v2-tool-card">
      ...
      <div className="tb-v2-tool-output-body">
        {result ? (
              ...
              <div>
                <div
                  style={{
                    fontWeight: 700,
                    fontSize: 18,
                    color: result.isPalindrome ? '#10b981' : '#ef4444',
                  }}
                >
                  {result.isPalindrome ? 'Palindrome!' : 'Not a Palindrome'}
                </div>
                <div style={{ fontSize: 13, color: 'var(--tb-text-secondary)' }}>
                  &quot;{text}&quot; {result.isPalindrome ? 'reads the same' : 'does not read'} forwards
                  and backwards
                </div>
              </div>
            </div>
          ...
          <div className="tb-v2-empty">Enter text to check if it&apos;s a palindrome</div>
        )}
      </div>
    </div>
  );
