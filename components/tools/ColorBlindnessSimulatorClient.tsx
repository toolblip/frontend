  ...
  return (
    <div className="tb-v2-card">
      <div className="tb-v2-card-header">
        <h2 className="tb-v2-card-title">Color Blindness Simulator</h2>
      ...
      <div className="tb-v2-form-group">
        <label className="tb-v2-label">Pick a Color</label>
        ...
        <div className="mt-3">
          <p className="tb-v2-label mb-2">Preset Colors</p>
      ...
      <div className="tb-v2-form-group">
        <div className="tb-v2-label">Original Color</div>
      ...
      <div className="tb-v2-form-group">
        <div className="tb-v2-label">Simulated Views</div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {colorBlindnessTypes.map((type) => (
            <div key={type.name} className="tb-v2-card p-4">
      ...
      <div className="tb-v2-form-group">
        <div className="tb-v2-label">Side-by-Side Comparison</div>
      ...
      <div className="tb-v2-form-group">
        <div className="tb-v2-label">Test Gradient</div>
