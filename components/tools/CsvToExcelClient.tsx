...
export default function CsvToExcelClient() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-2xl font-bold">Csv To Excel</h1>
      <p className="text-gray-600 dark:text-gray-400">Convert CSV files to Excel format. Download as .xlsx with proper formatting.</p>
      <textarea
        value={input}
